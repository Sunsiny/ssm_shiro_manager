...
<body class="childrenBody">
	...
	<input type="hidden" name="id" value="${carousel.id }"/>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input userName"
					lay-verify="required" placeholder="请输入描述信息" name="remark" value="${carousel.remark }">
			</div>
		</div>
		...
		<label class="layui-form-label">新闻封面</label>
		  <div class="layui-input-block">
			...
			<img class="layui-upload-img" id="preview" style="width: 150px;margin-top: 5px" src="${ctx }/file/showPic?fileName=${carousel.imgurl }">
			<p id="uploadError"></p>
			<input type="hidden" lay-verify="imgurl" name="imgurl" id="newsImg" value="${carousel.imgurl }"/>
		  </div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="imglink" class="layui-input userName"
					lay-verify="url" placeholder="链接地址" value="${carousel.imglink }">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="sorting" class="layui-input userName"
					lay-verify="number" placeholder="排序" value="${carousel.sorting }">
			</div>
		</div>
	...
	<script type="text/javascript" src="${ctx }/page/carousel/editCarousel.js"></script>
</body>
</html>